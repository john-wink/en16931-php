...
**176 rules fully implemented, 1 partial, 101 open** — measured against the official EN 16931 validation artefacts **1.3.16** and the XRechnung Schematron **2.5.0 (XRechnung 3.0.2)** (278 business rules in total). The full per-rule matrix lives in [COVERAGE.md](COVERAGE.md).
